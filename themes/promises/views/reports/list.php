...
<div id="incident_<?php echo $incident_id ?>" class="rb_report problem <?php echo $incident_verified_class; ?>">
	<div class="p-body">
		<!-- category -->					
		<div class="p-meta">
		...
		<!-- content -->
		<h2><a href="<?php echo $incident_url; ?>"><?php echo html::escape($incident_title); ?></a></h2>
		
		<table><tbody><tr valign="top">
			<td class="r_photo"><a href="<?php echo $incident_url; ?>"><img alt="<?php echo html::escape($incident_title); ?>" src="<?php echo $incident_thumb; ?>" height="59" width="89"></a></td>
		
			<td><div class="inner"><?php echo $incident_description; ?></div></td>
			</tr></tbody>
		</table>
			
		<!-- details -->  													
		<ul class="p-buttons small clearfix">
			<li><?php echo $incident_verified; ?></li>
			<li><?php echo $incident_date; ?></li>							
			<li><?php echo html::specialchars($location_name); ?></li>
		</ul>
	</div>
</div>
